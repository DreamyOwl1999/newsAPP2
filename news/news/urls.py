...
from main.views import like_article, get_likes, get_pp, delete_pp
...
urlpatterns = [
    ...
    path('login/main/profile_load/get_pp', get_pp, name = 'get_pp'),
    path('login/main/profile_load/delete_pp', delete_pp, name = 'delete_pp')
